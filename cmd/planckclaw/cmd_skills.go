...
func skillsHelp() {
	...
	fmt.Println("  planckclaw skills list")
	fmt.Println("  planckclaw skills install baso53/planckclaw-skills/weather")
	fmt.Println("  planckclaw skills install-builtin")
	fmt.Println("  planckclaw skills list-builtin")
	fmt.Println("  planckclaw skills remove weather")
	fmt.Println("  planckclaw skills install --registry clawhub github")
}
...
func skillsInstallCmd(installer *skills.SkillInstaller, cfg *config.Config) {
	if len(os.Args) < 4 {
		fmt.Println("Usage: planckclaw skills install <github-repo>")
		fmt.Println("       planckclaw skills install --registry <name> <slug>")
		return
	}
	...
	if os.Args[3] == "--registry" {
		if len(os.Args) < 6 {
			fmt.Println("Usage: planckclaw skills install --registry <name> <slug>")
			fmt.Println("Example: planckclaw skills install --registry clawhub github")
			return
		}
...
func skillsInstallBuiltinCmd(workspace string) {
	builtinSkillsDir := "./planckclaw/skills"
...
func skillsListBuiltinCmd() {
	...
	builtinSkillsDir := filepath.Join(filepath.Dir(cfg.WorkspacePath()), "planckclaw", "skills")
